    ...
    if (oldJson) {
        try {
            ...
            if(oldJSON.definitions && oldJSON.definitions.translations && oldJSON.definitions.translations.properties) {
                ...
                Object.keys(oldJSON.properties).forEach((key) =>  { 
                    if(key.properties) {
                        Object.keys(key.properties).forEach((keyB) => { oldKeys.push(keyB) })
                    }
                })
            }
            let newKeys = []
            if(newObj.definitions && newObj.definitions.translations && newObj.definitions.translations.properties) {
                ...
                Object.keys(newObj.properties).forEach((key) =>  { 
                    if(key.properties) {
                        Object.keys(key.proprties).forEach((keyB) => { newKeys.push(keyB) })
                    }
                })
            }
